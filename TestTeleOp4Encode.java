...
@TeleOp(name="TestTeleOp4Encode", group="ahert")  // @Autonomous(...) is the other common choice
//@Disabled

public class TestTeleOp4Encode extends OpMode {
    ...
    public void loop() {
        ...
        if (gamepad2.left_bumper) {                     // Change shield mode to 0
            ...
            backShieldMode = 0;                // Change shield mode to 1
        }
        ...
        if (gamepad2.right_bumper) {                  // Launcher control
            ...
            newLauncherTarget = launcher.getCurrentPosition() + (int) (1 * COUNTS_PER_MOTOR_REV);
