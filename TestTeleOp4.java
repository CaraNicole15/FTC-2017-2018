...
@TeleOp(name="TestTeleOp4", group="ahert")  // @Autonomous(...) is the other common choice
//@Disabled

public class TestTeleOp4 extends OpMode {
    ...
    DcMotor launcher;                // The launcher functions to shoot the balls into the goal

    DcMotor lift;                // The lift functions to cap the ball
   ...
   // DcMotor LEDs;
    ...
    public void loop() {
        ...
        double cap_ball = -gamepad2.right_stick_y;

        // clip the right/left values so that the values never exceed +/- 1

        cap_ball = Range.clip(cap_ball, -1, 1);

        lift.setPower(1.0*cap_ball);

        //Kraken CONTROL
        ////////////////////////////////////////////////////////////////////////////////////////

        if (gamepad1.left_bumper)                   // Kraken control for drive controller
            kraken.setPower(1.0);
