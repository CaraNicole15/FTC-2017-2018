...
@TeleOp(name="TestTeleOp4Kraken", group="ahert")  // @Autonomous(...) is the other common choice
//@Disabled

public class TestTeleOpKraken extends OpMode {
   ...
   // DcMotor LEDs;
    ...
    public void loop() {
        ...
        //Ball Loader CONTROL
        ////////////////////////////////////////////////////////////////////////////////////////////
        if (gamepad2.dpad_up) {                     // Change shield mode to 0
            backShieldMode = 1;
        ...
        if (gamepad2.left_bumper)                   // Kraken control for launcher controller
            kraken.setPower(1.0);
